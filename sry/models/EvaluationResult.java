...
public class EvaluationResult {
    ...
    public EvaluationResult(String postfixExpression, int result, long executionTimeNs, int pushCount, int popCount, int comparisonCount) {
    ...
    public String getOpCount() {
        return "Push=" + pushCount + ", Pop=" + popCount + ", Comp=" + comparisonCount;
    }
}
